...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getListItemsByIdUser(long userId, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getListItemsByText(String text, long userId, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
